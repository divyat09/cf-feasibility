...
for epoch in range(args.epoch):    
    if epoch%10<0:
            loss_val.append( train_cflabel_likelihood_loss( cf_vae, cf_vae_optimizer, normalise_weights, validity_reg, oracle_reg, 1, 1, batch_size) )
            print('Good CF')
    else:
            loss_val.append( train_cflabel_likelihood_loss( cf_vae, cf_vae_optimizer, normalise_weights, validity_reg, oracle_reg, margin, 0, 1, batch_size) )        
            print('VAE Stability+GoodCF')
