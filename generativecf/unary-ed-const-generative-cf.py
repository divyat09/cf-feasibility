...
base_data_dir='data/'
if args.htune:
    base_model_dir='htune/model-approx-ed/'
else:
...
torch.save(cf_vae.state_dict(),  base_model_dir + dataset_name + '-margin-' + str(args.margin)  + '-constraint-reg-' + str(args.constraint_reg) + '-validity_reg-'+ str(args.validity_reg) + '-epoch-' + str(args.epoch) + '-' + 'unary-ed-gen' + '.pth')